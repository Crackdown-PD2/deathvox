...
--[[
	--todo create a suitable hud animation to replace the on-damage health radial flash for when sociopath is active
	
	function HUDTeammate:_damage_taken()
		if not alive(self._sociopath_health) then 
