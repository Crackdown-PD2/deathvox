...
Hooks:PostHook( WeaponFactoryTweakData, "init", "totalcd_weaps", function(self)
	...
	--Barrel extension stat changes begin here. (don't feel like commenting these either noobs)
		...
		self.parts.wpn_fps_upg_ns_ass_smg_medium.stats = {suppression = 72,	value = 2}
		self.parts.wpn_fps_upg_ns_ass_smg_large.stats = {suppression = 72,	value = 5}
		...
		self.parts.wpn_fps_upg_ns_pis_medium_slim.stats = {suppression = 72, value = 1}
		self.parts.wpn_fps_upg_ns_pis_large.stats = {suppression = 72, value = 5}
		self.parts.wpn_fps_upg_ns_pis_large_kac.stats = {suppression = 72, value = 6}
		self.parts.wpn_fps_upg_ns_pis_small.stats = {suppression = 72, value = 3}
		self.parts.wpn_fps_upg_pis_ns_flash.stats = {suppression = 72, value = 4}
		self.parts.wpn_fps_upg_ns_pis_meatgrinder.stats = {suppression = 72, value = 7}
		self.parts.wpn_fps_upg_ns_pis_ipsccomp.stats = {suppression = 72, value = 4}
		self.parts.wpn_fps_upg_ns_pis_medium.stats = {suppression = 72, value = 1}
		self.parts.wpn_fps_upg_ns_pis_medium_gem.stats = {suppression = 72, value = 4}
		self.parts.wpn_fps_upg_ns_pis_medium_slim.stats = {suppression = 72, value = 1}
