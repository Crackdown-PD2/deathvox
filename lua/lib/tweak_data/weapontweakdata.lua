...
function WeaponTweakData:_set_sm_wish()
	...
	self.swat_van_turret_module.EXPLOSION_DMG_MUL = 2 -- tentative, base is 7
	...
	self.ceiling_turret_module.EXPLOSION_DMG_MUL = 2 -- tentative, base is 7
	...
	self.ceiling_turret_module_longer_range.CAN_GO_IDLE = true
