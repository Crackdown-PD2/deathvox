function FireTweakData:init(tweak_data)
	...
	self.effects = {
		endless = {
			...
			cheap = "effects/payday2/particles/explosions/molotov_grenade_enemy_on_fire_endless",
			normal = "effects/payday2/particles/explosions/molotov_grenade_enemy_on_fire_endless"
		},
		hellfire_endless = {
			expensive = "effects/pd2_mod_gageammo/particles/explosions/hellfire_endless",
			cheap = "effects/pd2_mod_gageammo/particles/explosions/hellfire_endless_cheap",
			normal = "effects/pd2_mod_gageammo/particles/explosions/hellfire_endless_nolight"
		},
		short = {
